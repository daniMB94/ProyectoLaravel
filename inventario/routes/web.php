...
Route::prefix('admin')->middleware(['auth', 'verified', 'middlewareRole:admin'])->group(function () {
    ...
    Route::get('/dashboard/formUpdateProduct/{producto}', [ProductoController::class, 'edit'])->name('dashboard.formUpdateProduct');
    Route::post('/dashboard/updateProduct', [ProductoController::class, 'update'])->name('dashboard.updateProduct');
