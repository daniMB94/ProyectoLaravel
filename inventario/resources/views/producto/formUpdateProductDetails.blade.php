<section>
    ...
    <form method="POST" action="{{ route('dashboard.updateProduct') }}" enctype="multipart/form-data">
        @csrf
        ...
        <input type="hidden" name="id_categoria" value="{{ $producto->categoria_id }}">
        ...
        <text-input>Localizacion Asignada correctamente</text-input>
        <br>
    ...
    <x-modal>
        ...
        <div
            ...
            <form method="POST" action="{{ route('localizaciones.store') }}" enctype="multipart/form-data">
                ...
                <x-primary-button class="ms-4">
                    {{ __('Guardar la nueva localizacion') }}
                </x-primary-button>
